...
public class FileUtil {
        ...
        public static String readZipFileString(String zipFile,
                        String findEntry, boolean regexp) throws Exception {
                ZipFile zf = new ZipFile(zipFile);
                InputStream in = new BufferedInputStream(new FileInputStream(
                                zipFile));
                ZipInputStream zin = new ZipInputStream(in);
        ...
        public static String getFileData(String zipFile, String findFile,
                ...
                if (fileStuffix.equals(IPA_STUFFIX)) {
                        ...
                        info = PListUtil.getZipFileContent(zipFile, findFile,
                                        regexp);
                } else if (fileStuffix.equals(APK_STUFFIX)) {
                        if (findFile == null || findFile.equals("")) {
                                findFile = ApkUtil.ANDROID_MAINFEST_XML;
                        }
                        info = ApkUtil.getZipFileContent(zipFile, findFile,
                                        regexp);
                }
                return info;
        }
